...
<div class="mt-2">
    <form action="{{url('admin/update/product/'.$product->slug)}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            <div class="form-group{{ $errors->has('brand') ? ' has-error' : '' }} col-lg-6 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="brand" id="brand" placeholder="Product Brand" value="{{$product->brand}}">
                @if ($errors->has('brand'))
                <span class="help-block">
            ...
            <div class="form-group{{ $errors->has('short_description') ? ' has-error' : '' }} col-lg-12 col-md-12 col-sm-12">
                ...
                <textarea type="text" class="form-control" name="short_description" id="short_description" placeholder="Short Description" cols="30" rows="6">{{$product->short_description}}</textarea>
            ...
            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} col-lg-12 col-md-12 col-sm-12">
                ...
                <textarea type="text" class="form-control" name="description" id="description" placeholder="Description" cols="30" rows="6">{{$product->description}}</textarea>
            ...
            <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }} col-lg-12 col-md-12 col-sm-12">
                ...
                <img src="{{asset($product->thumbnail)}}" alt="{{$product->name}}" width="50px">
            </div>
